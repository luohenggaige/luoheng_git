...
<body>
	<table class="table" align="center">
		<tr style="background: #66CCFF; height: 120px; ">
			<td width="100%" style="padding:5px;" colspan="2" align="center" valign="top">
				<iframe frameborder="0" width="120" src="${path}/index/toTop.do" name="top"></iframe>
			</td>
		</tr>
			
		<tr>
			<td height="900px" style="padding:5px;background: #99FFCC;">
				<iframe frameborder="0" src="${path}/index/toBody.do" name="body"></iframe>
			</td>
			<td width="120" height="900px" style="padding:5px;background: #f60;" align="center" valign="right">
